...
for "_i" from 0 to (count _locations - 1) do {
    ...
    if (_type in _cities) then {
        ...
        */
		if (_position distance getMarkerPos "safe_area_1" < 400) exitWith {};
		if (_position distance getMarkerPos "safe_area_2" < 400) exitWith {};
		if (_position distance getMarkerPos "safe_area_3" < 400) exitWith {};
		if (_position distance getMarkerPos "safe_area_4" < 400) exitWith {};
		if (_position distance getMarkerPos "safe_area_5" < 400) exitWith {};
		if (_position distance getMarkerPos "safe_area_6" < 400) exitWith {};
		if (_position distance getMarkerPos "safe_area_7" < 400) exitWith {};
		if (_position distance getMarkerPos "safe_area_8" < 400) exitWith {};
		if (_position distance getMarkerPos "safe_area_9" < 400) exitWith {};
		if (_position distance getMarkerPos "safe_area_10" < 400) exitWith {};
